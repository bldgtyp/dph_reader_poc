...
4–5 tabled, the work moved to [`POC/`](POC/.index.md) — phased implementation plans for a
...
([`POC/RESULTS/POC-5_results.md`](POC/RESULTS/POC-5_results.md) §6) confirms neither tabled phase
...
1. Write findings into `planning/RESULTS/PHASE-N_results.md` — **including negative results.**
...
Primary reference set at [`../_adephi_st_example_files/`](../_adephi_st_example_files) — the same
...
2.4.0 BETA sample is `_misc_test_files/designph_test.skp`.
