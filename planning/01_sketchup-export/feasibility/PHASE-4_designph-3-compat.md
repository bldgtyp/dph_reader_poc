...
uv run tools/skp_attr_dump.py "<model saved from 3.0>.skp" -d DesignPH_dict \
  > ../planning/01_sketchup-export/feasibility/RESULTS/dph3_<model>.txt
diff ../planning/01_sketchup-export/feasibility/RESULTS/baseline_<model>.txt ../planning/01_sketchup-export/feasibility/RESULTS/dph3_<model>.txt
```
...
- `planning/01_sketchup-export/feasibility/RESULTS/PHASE-4_results.md` with the baseline diffs
