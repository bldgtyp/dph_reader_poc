...
| 0.2 Results folder | `planning/01_sketchup-export/feasibility/RESULTS/` | done (pre-existing) |
...
14 models baselined: the primary Adelphi model, the two `corpus/synthetic` samples, and all 11
...
| `planning/01_sketchup-export/feasibility/00_OVERVIEW.md` | Status banner · secondary corpus corrected to 11 files / five projects; Linde 250703 added |
| `planning/01_sketchup-export/feasibility/PHASE-0_setup-and-long-leads.md` | Completion banner; deliverables ticked; as-run notes on §0.3 |
| `planning/01_sketchup-export/feasibility/PHASE-1_read-side-facts.md` | §1.1 rewritten around the refuted rule and marked blocking · §1.3 pruned to what is still open · **§1.4 and §1.5 new** (assembly resolution, the shading filter) · gate and deliverables updated · box 3 h → 4 h |
| `planning/.index.md`, `planning/01_sketchup-export/feasibility/RESULTS/.index.md`, `planning/spikes/.index.md` | Status table; new folder indexes |
