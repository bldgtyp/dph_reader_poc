...
| `planning/01_sketchup-export/feasibility/PHASE-1_read-side-facts.md` | Progress banner; §1.1, §1.3, §1.4 marked answered; §1.2 and §1.5 carry the staged scripts |
| `planning/01_sketchup-export/feasibility/00_OVERVIEW.md`, `planning/.index.md`, `RESULTS/.index.md`, `spikes/.index.md` | Status and new files |
