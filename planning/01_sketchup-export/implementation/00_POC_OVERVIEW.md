...
[`../feasibility/RESULTS/PHASE-3_results.md`](../feasibility/RESULTS/PHASE-3_results.md)
...
`planning/01_sketchup-export/feasibility/RESULTS/PHASE-3_licence-question.md` blocks **v1** on the AGPL question because v1 means
...
pocs/01_sketchup-export/
  ...
  tools/
    ...
    build_rbz.py                 ported; builds pocs/01_sketchup-export/dist/dph_plus_poc.rbz; staleness-checks the zip
...
- Everything captured from real corpus models — fixtures, extractions, HBJSON outputs, reports —
  lives under **`pocs/01_sketchup-export/_private/`** (gitignored): it is **client project data** and stays out of any
