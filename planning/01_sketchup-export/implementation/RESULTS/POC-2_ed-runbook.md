...
| **B** — capture the fixtures | ✅ **5 of 5**, reconciled PASS. `pocs/01_sketchup-export/_private/MANIFEST.md` |
...
- **Rebuild before capturing** (`cd pocs/01_sketchup-export && make ed`) whenever the collector has changed — though
