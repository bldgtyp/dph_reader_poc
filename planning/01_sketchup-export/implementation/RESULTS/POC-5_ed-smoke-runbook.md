...
| Copies | the five model copies live in `~/Desktop/dph_poc_copies/`. If one is missing, re-copy it from the source listed in `pocs/01_sketchup-export/_private/MANIFEST.md` — copy the file in Finder, never open the original |
