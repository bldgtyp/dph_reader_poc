...
>
> **Superseded by the POC.** Everything here has been rebuilt and extended in `planning/POC/`; this
...
- `planning/RESULTS/PHASE-3_results.md` with the measurement table and a clear verdict
