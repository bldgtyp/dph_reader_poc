...
Usage:
    uv run poc/tools/validate_output.py                       # a synthetic model carrying every payload
    uv run poc/tools/validate_output.py --hbjson MODEL.hbjson # a captured real output
"""
