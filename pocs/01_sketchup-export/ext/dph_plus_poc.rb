...
# question (`planning/01_sketchup-export/feasibility/RESULTS/PHASE-3_licence-question.md`) blocks *release*,
# and sharing the `.rbz` is the act that would change the legal footing.
# See `planning/01_sketchup-export/implementation/00_POC_OVERVIEW.md` §2.3.
#
