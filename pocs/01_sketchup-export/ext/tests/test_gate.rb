...
#
#     ruby pocs/01_sketchup-export/ext/tests/test_gate.rb
#
# Every row of both decision tables in `planning/01_sketchup-export/implementation/POC-4_integration.md` §1,
