...
in all 14 corpus models, offline, key by key —
`planning/01_sketchup-export/feasibility/RESULTS/baselines/corpus_baseline.json`.
...
Usage:
    uv run pocs/01_sketchup-export/tools/check_extraction.py ~/Desktop/dph_poc_copies/*.extraction.json
    uv run pocs/01_sketchup-export/tools/check_extraction.py --baseline <path> FILE...
"""
...
LIVE_MEASUREMENTS: dict[str, dict[str, int]] = {
    # `planning/01_sketchup-export/feasibility/RESULTS/PHASE-1_results.md`: `glued_to` resolved 46 of 46.
