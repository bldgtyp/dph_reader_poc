...
Usage:
    uv run pocs/01_sketchup-export/tools/verify_in_chrome.py
    uv run pocs/01_sketchup-export/tools/verify_in_chrome.py --headed --chrome /path/to/Chromium
"""
...
DEFAULT_OUT = REPO / "planning" / "01_sketchup-export" / "implementation" / "RESULTS" / "baselines"
